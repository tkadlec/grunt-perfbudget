...
grunt-perfbudget is a [Grunt.js](https://github.com/cowboy/grunt/) task for automating performance analysis and enforce a performance budget. It uses the wonderful [webpagetest.org](http://webpagetest.org) and the [WebPageTest API Wrapper for NodeJS](https://github.com/marcelduran/webpagetest-api) created by [Marcel Duran](https://github.com/marcelduran).
